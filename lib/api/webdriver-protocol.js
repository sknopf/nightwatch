...
var WebdriverCommand = require('../core/webdriver-command');
...
module.exports = function(Nightwatch) {
  ...
  function element(using, value, callback) {
    using = using === 'css selector' ? 'css' : using;

    var strategies = ['class name', 'css selector', 'css', 'id', 'name', 'link text',
    ...
    var by = webdriver.By[using](value);
    return processWebdriverCommand(Nightwatch.driver, 'findElement', by, callback);
  }
  ...
  function elements(using, value, callback) {
    ...
    var check = /class name|css selector|css|id|name|link text|partial link text|tag name|xpath/gi;
    if (!check.test(using)) {
    ...
    var by = webdriver.By[using](value);
    return processWebdriverCommand(Nightwatch.driver, 'findElements', by, callback);
  }
  ...
  Actions.elementIdAttribute = function(id, attributeName, callback) {
    return processWebdriverCommand(id, 'getAttribute', attributeName, callback);
  };
   ...
   * @api protocol
   */
  Actions.elementIdClick = function(callback) {
    return processWebdriverCommand(Nightwatch.driver, 'click', callback);
  };
  ...
  Actions.elementIdCssProperty = function(id, cssPropertyName, callback) {
    return processWebdriverCommand(id, 'getCssValue', cssPropertyName, callback);
  };
  ...
  Actions.elementIdEnabled = function(id, callback) {
    return processWebdriverCommand(id, 'isEnabled', callback);
  };
  ...
  Actions.elementIdText = function(id, callback) {
    return processWebdriverCommand(Nightwatch.driver, 'getText', id, callback);
  };
  ...
  Actions.elementIdValue = function(id, value, callback) {
    ...
    return processWebdriverCommand(id, 'sendKeys', value, callback);
  };
  ...
  Actions.url = function(url, callback) {
    return processWebdriverCommand(Nightwatch.driver, 'get', url, callback);
  ...
  // Helpers
  /////////////////////////////////////////////////////////////////////////////
  function processWebdriverCommand(obj, command, args, callback) {
    var c = new WebdriverCommand();
    return c.executeCommand(obj, command, args, callback);
  }
